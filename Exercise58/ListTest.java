 ...
 */
	...
	public void testSortByDistance() {
		...
		Toy t2 = new Toy("robot", 22.05, 3);
		Toy t3 = new Toy("gun", 15, 4);
		Toy t4 = new Toy("goku", 11, 4);
		EmtyList mt = new EmtyList();
		Inventory l4 = mt.insert(t1);
		Inventory l3 = l4.insert(t2);
		Inventory l2 = l3.insert(t3);
		Inventory l1 = l2.insert(t4);
		System.out.println(l1.sortByPrice());
